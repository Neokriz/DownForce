  ...
  void Reset() {
    ...
    file_iter_ = cfd_->table_cache()->NewIterator(
        ...
        *files_[file_index_],
        ...
        /*file_read_hist=*/nullptr, /*user_read_hist=*/nullptr,
        /*background_read_hist=*/nullptr, /*file_read_hist_int=*/nullptr,
        /*user_read_hist_int=*/nullptr, /*background_read_hist_int=*/nullptr,
...
void ForwardIterator::RebuildIterators(bool refresh_sv) {
  ...
  for (const auto* l0 : l0_files) {
    ...
    l0_iters_.push_back(cfd_->table_cache()->NewIterator(
        ...
        /*file_read_hist_int=*/nullptr, /*user_read_hist_int=*/nullptr,
        /*background_read_hist_int=*/nullptr, TableReaderCaller::kUserIterator,
