...
class TableCache {
 public:
  ...
  InternalIterator* NewIterator(
      ...
      Arena* arena, bool skip_filters, int level,
  ...
  Status Get(const ReadOptions& options,
             ...
             HistogramImpl* file_read_hist_int = nullptr,
             HistogramImpl* user_read_hist_int = nullptr,
             HistogramImpl* background_read_hist_int = nullptr,
  ...
  Status MultiGetFilter(const ReadOptions& options,
                        ...
                        HistogramImpl* background_read_hist_int, int level,
